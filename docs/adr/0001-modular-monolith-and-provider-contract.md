...
OpenMPI uses a modular monolith with separate API and MLLP processes. Domain and application modules remain version- and provider-neutral. `IIdentityRegistryStore` is the only persistence boundary.
