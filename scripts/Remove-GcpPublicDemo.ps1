...
if (-not $ConfirmRemoval) {
    throw "Pass -ConfirmRemoval to delete the exact UnifyEMPI public-demo resources."
}

$expectedPrefix = "unifyempi-demo"
...
Write-Output "Removed the UnifyEMPI public-demo services, store, secret, images and service account."
