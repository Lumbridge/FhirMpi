...
hero:
  ...
  actions:
    - text: Start locally
      ...
      icon: right-arrow
    - text: Explore the synthetic demo
...
<div class="status-line">
	...
	<Badge text="Synthetic demo live" variant="success" />
</div>
...
UnifyEMPI is not a certified clinical product. Use only synthetic data in demonstrations.
...
<div class="link-grid">
	...
	<LinkCard
		...
		description="Open the live synthetic API CapabilityStatement."
