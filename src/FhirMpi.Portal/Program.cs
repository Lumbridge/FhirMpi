...
using FhirMpi.Portal;
using FhirMpi.Portal.Components;
...
if (!string.IsNullOrWhiteSpace(portalOptions.DataProtectionKeyPath))
{
    builder.Services.AddDataProtection()
        .SetApplicationName("FhirMpi.Portal")
...
if (authentication.Enabled)
{
    ...
    builder.Services
        ...
        .AddCookie(options =>
        {
            options.Cookie.Name = "__Host-FhirMpi.Portal";
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource.AddService("FhirMpi.Portal"))
