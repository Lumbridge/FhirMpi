...
{
    internal const string InternalSystem = "https://fhir-mpi.dev/CodeSystem/internal-resource";
    internal const string BlockingSystemPrefix = "https://fhir-mpi.dev/CodeSystem/blocking/";
    internal const string SourceKeySystemPrefix = "https://fhir-mpi.dev/Id/source-key/";
    private const string EnterpriseExtension = "https://fhir-mpi.dev/StructureDefinition/enterprise-id";
    private const string SourceLocalIdExtension = "https://fhir-mpi.dev/StructureDefinition/source-local-id";
    private const string SourceTrustExtension = "https://fhir-mpi.dev/StructureDefinition/source-trust";
    private const string CreatedAtExtension = "https://fhir-mpi.dev/StructureDefinition/created-at";
    private const string SourcesExtension = "https://fhir-mpi.dev/StructureDefinition/source-links";
    private const string LogicalVersionExtension = "https://fhir-mpi.dev/StructureDefinition/logical-version";
    private const string ReviewEnvelopeExtension = "https://fhir-mpi.dev/StructureDefinition/review-envelope";
    private const string AuditEnvelopeExtension = "https://fhir-mpi.dev/StructureDefinition/audit-envelope";
    private const string ReceiptEnvelopeExtension = "https://fhir-mpi.dev/StructureDefinition/receipt-envelope";
    private const string SettingsEnvelopeExtension = "https://fhir-mpi.dev/StructureDefinition/tenant-settings-envelope";
    ...
    public static Person ToPerson(EnterprisePerson person, TenantId tenant)
    {
        ...
        for (var index = 0; index < person.Links.Count; index++)
        {
            ...
            fhirLink.Extension.Add(new Extension(
                "https://fhir-mpi.dev/StructureDefinition/linked-at",
                new FhirDateTime(domainLink.LinkedAt)));
            fhirLink.Extension.Add(new Extension(
                "https://fhir-mpi.dev/StructureDefinition/link-reason",
