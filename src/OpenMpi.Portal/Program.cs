...
using OpenMpi.Portal;
using OpenMpi.Portal.Components;
...
if (!string.IsNullOrWhiteSpace(portalOptions.DataProtectionKeyPath))
{
    builder.Services.AddDataProtection()
        .SetApplicationName("OpenMpi.Portal")
...
if (authentication.Enabled)
{
    ...
    builder.Services
        ...
        .AddCookie(options =>
        {
            options.Cookie.Name = "__Host-OpenMpi.Portal";
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource.AddService("OpenMpi.Portal"))
