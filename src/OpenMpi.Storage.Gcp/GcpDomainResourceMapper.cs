...
namespace OpenMpi.Storage.Gcp;

internal static class GcpDomainResourceMapper
{
    internal const string InternalSystem = "https://openmpi.dev/CodeSystem/internal-resource";
    internal const string BlockingSystemPrefix = "https://openmpi.dev/CodeSystem/blocking/";
    internal const string SourceKeySystemPrefix = "https://openmpi.dev/Id/source-key/";
    private const string EnterpriseExtension = "https://openmpi.dev/StructureDefinition/enterprise-id";
    private const string SourceLocalIdExtension = "https://openmpi.dev/StructureDefinition/source-local-id";
    private const string SourceTrustExtension = "https://openmpi.dev/StructureDefinition/source-trust";
    private const string CreatedAtExtension = "https://openmpi.dev/StructureDefinition/created-at";
    private const string SourcesExtension = "https://openmpi.dev/StructureDefinition/source-links";
    private const string LogicalVersionExtension = "https://openmpi.dev/StructureDefinition/logical-version";
    private const string ReviewEnvelopeExtension = "https://openmpi.dev/StructureDefinition/review-envelope";
    private const string AuditEnvelopeExtension = "https://openmpi.dev/StructureDefinition/audit-envelope";
    private const string ReceiptEnvelopeExtension = "https://openmpi.dev/StructureDefinition/receipt-envelope";
    private const string SettingsEnvelopeExtension = "https://openmpi.dev/StructureDefinition/tenant-settings-envelope";
    ...
    public static Person ToPerson(EnterprisePerson person, TenantId tenant)
    {
        ...
        for (var index = 0; index < person.Links.Count; index++)
        {
            ...
            fhirLink.Extension.Add(new Extension(
                "https://openmpi.dev/StructureDefinition/linked-at",
                new FhirDateTime(domainLink.LinkedAt)));
            fhirLink.Extension.Add(new Extension(
                "https://openmpi.dev/StructureDefinition/link-reason",
